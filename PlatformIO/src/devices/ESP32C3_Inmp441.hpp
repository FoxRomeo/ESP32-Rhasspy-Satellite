...
// I2S pins on ESP32-C3 (SuperMini, etc)
//GPIO2 <--> SD
//GPIO3 <--> WS
//GPIO4 <--> SCK
...
// LEDs
#define LED_STREAM 10
#define LED_WIFI 1

// #define WS2812B_DATA_PIN 9
// #define WS2812B_NUM_LEDS 4


// class DetectWakeWordState;

class ESP32C3_Inmp441 : public Device
{
  public:
    ESP32C3_Inmp441();
    void init();
...
ESP32C3_Inmp441::ESP32C3_Inmp441() {};


void ESP32C3_Inmp441::init() {
...
void ESP32C3_Inmp441::updateColors(int colors)
{
  //  printf("colors: %d\n",colors);
...
bool ESP32C3_Inmp441::readAudio(uint8_t *data, size_t size) {
